...
def error():
    ...
    root.withdraw()
    messagebox.showerror("Out of powerups!", "Sorry you have no more powerups remaining for this course, press ok to continue...")
    try:
        root.destroy()
    except:
        pass
...
def setup(level):
    '''
    Setup objects for the level from module courses
    '''
...
def holeInOne():
    '''
    If player gets a hole in one display special mesage to screen
    '''
