...
class ball():
    ...
    def getSurf(self, hover=False):
        ...
        if self.locked == True:
            ...
            label = self.font.render('Unlocked', 1, (0,0,0,0))
            if self.equipped == False:
                buy = self.font.render('Equip', 1, (0,0,0,0))
                ...
                if pos[1] > i[1] + 80 and pos[1] < i[1] + i[3]:
                    if click == True:
                        ...
                        if ballObjects[c].locked == True:
                            if messagebox.askyesno('Confirm Purchase?', 'Are you sure you want to purchase this ball for 10 coins?'):
                                if int(getCoins()) >= 10:
                                    ...
                                    messagebox.showerror('oops, not enough coins!', 'You do not have enough coins to purchase this item!')
